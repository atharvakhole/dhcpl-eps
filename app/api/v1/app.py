...
@app.get("/api/v1/procedures/{procedure_name}", response_model=ProcedureDetailResponse)  
...
@app.post("/api/v1/procedures/{procedure_name}/execute", response_model=ProcedureExecutionResponse)
async def execute_procedure(procedure_name: str):
    """
    Execute a procedure
