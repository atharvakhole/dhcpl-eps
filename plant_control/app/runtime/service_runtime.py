...
class ServiceRuntime:
    def __init__(self, log_file_path: str, enable_console: bool=False, log_level=LogLevel.WARNING):
        self.config_manager = config_manager
        self.tag_service = None
        self.procedure_executor = None
        self.register_maps = None
        self.logger = setup_file_logging(log_file_path, enable_console, log_level)
